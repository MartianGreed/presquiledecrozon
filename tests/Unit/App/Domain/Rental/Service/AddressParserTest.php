...
class AddressParserTest extends TestCase
{
    ...
    {
        $this->assertAddressIsCorrectlyParsed(AddressParser::getParts($formattedAddress), $addressParts);
    }
    ...
    public static function addressProvider(): array
    {
        return [
            ...
            [
                '25 place Grégoire Bordillon, 49100 Angers, France', [
                    'address' => '25 place Grégoire Bordillon',
                    'postal_code' => '49100',
                    'town' => 'Angers',
                    'country' => 'France',
                ]],
            [
                '20 All. des Mouettes, 29560 Telgruc-sur-Mer, France', [
                    'address' => '20 All. des Mouettes',
                    'postal_code' => '29560',
                    'town' => 'Telgruc-sur-Mer',
                    'country' => 'France',
                ]],
            [
                '11 Rue du Menhir, 29160 Crozon, France', [
                    'address' => '11 Rue du Menhir',
                    'postal_code' => '29160',
                    'town' => 'Crozon',
                    'country' => 'France',
                ]],
            [
                '3 Rue du Mur, 29160 Crozon, France', [
                    'address' => '3 Rue du Mur',
                    'postal_code' => '29160',
                    'town' => 'Crozon',
                    'country' => 'France',
                ]],
            [
                '4 Rue du Château d\'Eau, 29570 Camaret-sur-Mer, France', [
                    'address' => '4 Rue du Château d\'Eau',
                    'postal_code' => '29570',
                    'town' => 'Camaret-sur-Mer',
                    'country' => 'France',
                ]],
        ];
    }
     ...
     * @param array<string, string> $addressParts
     */
    private function assertAddressIsCorrectlyParsed(array $parsedParts, array $addressParts): void
    {
